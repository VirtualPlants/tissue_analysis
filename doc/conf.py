...
# -*- coding: utf-8 -*-
#
# Package (Undefined, u'tissue_analysis') documentation build configuration file, created by
...
# import tissue_analysis as mypkg
...
project = u'vplants.tissue_analysis'
copyright = u'2015, vplants.tissue_analysis'
...
htmlhelp_basename = 'tissue_analysisdoc'
...
# [howto/manual]).
latex_documents = [
    ('index', 'tissue_analysis.tex',
     u'tissue_analysis Documentation',
     u'Jonathan Legrand', 'manual'),
]
...
man_pages = [
    ('index', 'tissue_analysis',
     u'tissue_analysis Documentation',
     [u'Jonathan Legrand'], 1)
]
...
texinfo_documents = [
    ('index', 'tissue_analysis',
     ...
     u'Jonathan Legrand',
     'tissue_analysis',
     'This package enable the analysis of 4D tissue data using spatio-temporal cellular features extraction, organisation and clustering.',
     'Miscellaneous'),
]
